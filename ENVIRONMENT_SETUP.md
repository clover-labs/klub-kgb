...
VITE_DIRECTUS_COLLECTION_NAME=blog_posts
```
...
|----------|-------------|---------|
| `VITE_DIRECTUS_URL` | Directus instance URL | `https://cms.cloverlabs.dev` |
| `VITE_DIRECTUS_COLLECTION_NAME` | Collection name for blog posts | `landing_test_posts` |
