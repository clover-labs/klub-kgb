...
<main class="flex flex-col gap-[5rem] md:gap-[12rem]">
	...
	>
		...
		<header class="w-full flex items-center justify-between px-2 md:px-4 py-2">
			...
			<nav class="flex items-center gap-4">
				<a
					class="text-pitch-black-100 hover:text-mean-green-500 font-calluna-sans-semibold uppercase"
				...
				<a
					class="text-pitch-black-100 hover:text-mean-green-500 font-calluna-sans-semibold uppercase"
					href="mailto:info@klub-kgb.si">Kontakt</a
				>
			</nav>
		</header>
	...
	<footer
		class="w-full flex items-center justify-between px-2 md:px-4 py-2 flex-col-reverse md:flex-row gap-4"
	>
		<span class="text-4xl font-cezanne">se vidimo!</span>
		<p class="text-pitch-black-100 text-sm font-calluna-sans-light">
