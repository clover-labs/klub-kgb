	...
	>
		<div class="relative w-full max-w-md rounded-lg bg-white shadow-2xl" onclick={(e) => e.stopPropagation()}>
			...
			<div class="p-8 text-center">
				<!-- Success Icon -->
				<div class="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-mean-green-500/10">
					<svg class="h-10 w-10 text-mean-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<div class="mb-6 space-y-3 font-calluna-sans-light text-gray-700">
					<p>
						Hvala za prijavo na naš newsletter!
					</p>
					<p>
						Prosimo, <strong class="font-calluna-sans-semibold">preverite vašo e-poštno predalo</strong> (ali spam mapo)
						za potrditveno sporočilo in sledite navodilom za dokončanje prijave.
					</p>
				</div>
				...
				<div class="mb-6 rounded-lg bg-prototype-orange-500/10 p-4">
					<div class="flex items-start gap-3">
						...
						<p class="text-sm font-calluna-sans-light text-gray-700">
							Če sporočila ne najdete, preverite mapo <strong class="font-calluna-sans-semibold">spam/neželena pošta</strong>.
						</p>
					</div>
				</div>
