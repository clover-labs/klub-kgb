      ...
      <div class="p-6">
        <div class="text-center flex flex-col gap-6 items-center">
          ...
          <div class="space-y-3 font-calluna-sans-light text-gray-700">
            <p>Hvala za vaše povpraševanje za najem prostora!</p>
            <p>
              Naša ekipa bo pregledala vašo zahtevo in <strong
                class="font-calluna-sans-semibold"
                >vas kontaktirala v najkrajšem možnem času</strong
...
{:else if isMobile}
  <Drawer.Root open={isOpen}>
    <Drawer.Content class="p-0 md:p-6 px-4 py-2">
      ...
      <Drawer.Footer class="flex !flex-col gap-4 px-0">
        <Button variant="pitch-black" size="lg" onclick={onClose}>
          V redu
        </Button>
      </Drawer.Footer>
