<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				"mean-green": "bg-mean-green-500 text-really-white-100 hover:bg-mean-green-400 shadow-sm",
				"mean-green-outline": "border-2 border-mean-green-500 bg-transparent text-mean-green-900 hover:bg-mean-green-500 hover:text-really-white-100",
				"brick-red": "bg-brick-red-500 text-really-white-100 hover:bg-brick-red-200 shadow-sm",
				"brick-red-outline": "border-2 border-brick-red-500 bg-transparent text-brick-red-900 hover:bg-brick-red-500 hover:text-really-white-100",
				"prototype-orange": "bg-prototype-orange-500 text-really-white-100 hover:bg-prototype-orange-400 shadow-sm",
