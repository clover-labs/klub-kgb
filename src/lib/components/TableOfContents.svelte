...
{#if variant === "sidebar"}
  <!-- Desktop Sidebar ToC -->
  <aside
    class="fixed right-8 top-32 z-30 hidden max-h-[calc(100vh-200px)] w-64 overflow-y-auto rounded-lg bg-really-white-100 p-6 shadow-card lg:block"
  >
    <nav>
      <ul class="space-y-2">
              ...
              <ul class="ml-6 mt-1 space-y-1 border-l border-gray-200 pl-3">
                {#each section.subsections as subsection}
                  <li>
                    ...
                    >
                      <span
                        class="text-xs font-calluna-sans-light {activeSection ===
                        subsection.id
