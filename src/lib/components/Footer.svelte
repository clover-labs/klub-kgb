...
<footer class="w-full bg-really-white-100 rounded-lg md:px-4 md:py-12 md:px-12">
  ...
  >
    ...
    <!-- Funny Quote -->
    <div class="my-24 flex flex-col gap-4 px-4">
      <h3 class="font-cezanne text-pitch-black-100 text-5xl">
        {m.footer_thought_of_day()}
      </h3>
      <RandomQuote className="text-2xl flex flex-col max-w-7xl gap-4" />
    </div>
    ...
    >
        ...
        <nav class="flex flex-wrap gap-4">
          {#each topPages as page}
            <a
              ...
              class="font-calluna-sans-light text-pitch-black-100 transition-colors hover:text-really-white-100"
            >
              {page.label}
            </a>
          {/each}
      ...
      <div class="flex items-center gap-4 flex-col-reverse md:flex-row">
        <div class="flex gap-4 items-center">
          <a
            aria-label="Facebook"
            href="https://www.facebook.com/klubkgbmaribor"
            target="_blank"
          >
            <svg
              class="size-8 stroke-pitch-black-100 hover:stroke-really-white-100"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <a
            ...
            href="https://www.instagram.com/kgbmaribor/"
            target="_blank"
          >
            <svg
              class="size-8 stroke-pitch-black-100 hover:stroke-really-white-100"
          ...
          <a
            aria-label="Threads"
            href="https://www.threads.com/@kgbmaribor"
            target="_blank"
          >
            <svg
              class="size-8 stroke-pitch-black-100 hover:stroke-really-white-100"
              ...
              ></g><g id="SVGRepo_iconCarrier"
                ><circle cx="12" cy="12" r="4"></circle><path
                  d="M16,8v5a3,3,0,0,0,3,3h0a3,3,0,0,0,3-3V12a9.87,9.87,0,0,0-.79-3.89,10,10,0,0,0-5.32-5.32,10,10,0,0,0-7.78,0A10,10,0,0,0,2.79,8.11a10,10,0,0,0,0,7.78,10,10,0,0,0,5.32,5.32,10,10,0,0,0,7.78,0"
                ></path></g
              ></svg
            >
          </a>
          ...
          >
            <svg
              class="size-8 stroke-pitch-black-100 hover:stroke-really-white-100 hover:fill-really-white-100"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 256 256"
              ><path
        ...
        <span class="text-4xl font-cezanne text-pitch-black-100 ml-4"
          >{m.footer_see_you()}</span
        >
      </div>
    </div>
  </div>
